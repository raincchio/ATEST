...
axs['bar1'].plot(x,y,'--',c='#1f77b4',zorder=2,alpha=1)
axs['bar1'].plot([1.5]*100,np.arange(0, 1, 0.01),'--',c='#1f77b4', label="CLIP",zorder=2)
axs['bar1'].plot(np.arange(1.5,3.1, 0.01),[0]*160,'--',c='#1f77b4',zorder=2)
axs['bar1'].plot(np.arange(0,3.1, 0.01),[1]*310,'-',c='black',alpha=0.4,zorder=1,label='CPI')
...
axs['bar2'].plot(np.arange(0,3.1, 0.01),[-1]*310,'-',c='black',zorder=1,alpha=.4)
...
l1 = axs['bar2'].plot(x,y,'--',zorder=2)
axs['bar2'].plot([0.5]*100,np.arange(-1, 0, 0.01),'--',c='#1f77b4',zorder=2)
axs['bar2'].plot(np.arange(0,0.5, 0.01),[0]*50,'--',c='#1f77b4',zorder=2)



axs['bar2'].set_ylim(0, -1.1)
axs['bar2'].set_xlim(0, 3.1)
axs['bar2'].set_xticks([0,0.5, 1])
axs['bar2'].set_xticklabels([0,r'$1-\epsilon$',r'$1$'])
axs['bar2'].set_yticks([-1])
axs['bar1'].set_xticks([0, 1, 1.5])
...
fig.legend(bbox_to_anchor=(0.5,0.7), edgecolor='None', facecolor='None')
plt.savefig('CLIPAndCPI.pdf')
